...
//        return -on_unit_sphere;
//}
//__host__ __device__ inline vec3 random_on_hemisphere_dding(const vec3& normal) {
//    vec3 on_unit_sphere = unit_vector(vec3::random(-1,1));
//    if (dot(on_unit_sphere, normal) > 0.0) // In the same hemisphere as the normal
//        return on_unit_sphere;
//    else
//        return -on_unit_sphere;
//}
//__host__ __device__ inline vec3 random_on_hemisphere_dding2(const vec3& normal) {
//    return random_unit_vector()+normal;
//    //vec3 on_unit_sphere = random_unit_vector()unit_vector(vec3::random(-1,1));
//    //if (dot(on_unit_sphere, normal) > 0.0) // In the same hemisphere as the normal
//    //    return on_unit_sphere;
//    //else
//    //    return -on_unit_sphere;
